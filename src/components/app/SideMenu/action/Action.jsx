import { badge,user, mic, deafen, addinguser} from "../../../../assets/images/icons/icons"
  ...
  return (
    <div className={ActionCSS.actionbar} >
        ...
        <div className="actions">
            ...
            <button><img src={deafen} alt="headphone" /></button>
            <button><img src={addinguser} alt="add friends" /></button>
        </div>
    </div>
  )
}